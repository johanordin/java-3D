...
public class HelloUniverse extends Applet {
	...
	Alpha alphaSpinMoon = new Alpha(0, 500);	
	...
	objRotSun.addChild(new Sphere(0.25f, Sphere.GENERATE_TEXTURE_COORDS, 200, app));
	...
	spinEarth.addChild(new Sphere(0.1f, Sphere.GENERATE_TEXTURE_COORDS, 200,appEarth));
	...
	spinMoon.addChild(new Sphere(0.04f, Sphere.GENERATE_TEXTURE_COORDS, 200,appMoon));
